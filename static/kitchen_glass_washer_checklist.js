/**
 * Kitchen Glass Washer Checklist - Frontend JavaScript
...
async function loadUnits() {
    try {
        const response = await fetch('/checklist/kitchen/glass-washer/units');
        if (response.ok) {
...
async function handleFormSubmit(e) {
    ...
    try {
        const response = await fetch('/checklist/kitchen/glass-washer/entries', {
            method: 'POST',
            headers: {
