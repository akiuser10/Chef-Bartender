...
// Load Units
function loadUnits() {
    fetch('/checklist/bar/closing/units')
...
function loadChecklistEntry() {
    ...
    fetch(`/checklist/bar/closing/entries?unit_id=${unitId}&entry_date=${entryDate}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                currentEntry = data;
...
function loadChecklistPoints(unitId) {
    fetch(`/checklist/bar/closing/points?unit_id=${unitId}`)
        .then(response => response.json())
        .then(data => {
...
function updateChecklistItem(pointId) {
    ...
    fetch('/checklist/bar/closing/entries', {
        method: 'POST',
        headers: {
...
function handlePointFormSubmit(e) {
    ...
    fetch('/checklist/bar/closing/points', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function generatePDF() {
    ...
    fetch('/checklist/bar/closing/pdf', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
